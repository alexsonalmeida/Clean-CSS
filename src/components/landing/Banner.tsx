...
export function Banner() {
    return (
        <section className="flex flex-col items-center self-center md:max-w-[1200px] px-6 md:px-8 space-y-5 md:space-y-10">
            ...
            <button className="flex items-center rounded-full text-purple-200 bg-gradient-to-r from-purple-700 to-purple-900 
